@php
    ...
    $kategoriSlug = \Illuminate\Support\Str::slug($namaKategori ?: 'lainnya');

    $kodeRak = optional($buku->rak)->kode_rak ?? '-';
    $lokasiRak = optional($buku->rak)->lokasi ?? 'Area Koleksi Umum';

    $stokTotal = $buku->stok_total ?? 0;
    $stokTersedia = $buku->stok_tersedia ?? 0;
    ...
    <section class="info-hero">
        <div class="info-hero-inner">
            <nav class="breadcrumb">
                <a href="{{ url('/katalog-admin') }}">Katalog</a>
    ...
    <section class="info-detail">
        <div class="info-detail-inner">
            ...
            <div class="info-right">
                <span class="info-kategori kategori-{{ $kategoriSlug }}">{{ $namaKategori }}</span>
        ...
        <div class="info-tabs-inner">
            <div class="info-tabs-card">
                ...
                <div class="tabs-header">
                    <button type="button" class="tab-btn active" data-tab="tambahan">Informasi Tambahan</button>
                    <button type="button" class="tab-btn" data-tab="lokasi">Lokasi Koleksi</button>
                </div>
                ...
                <div class="tab-content active" id="tab-tambahan">
                    <div class="info-grid">
                        ...
                        <div class="info-grid-row">
                            ...
                            <span class="grid-value">{{ $namaKategori }}</span>
                        </div>
                    </div>
                    ...
                    <div class="info-notice-box">
                        ...
                        <p>Buku ini tersedia untuk dipinjam sesuai aturan perpustakaan. Pastikan data buku selalu diperbarui agar katalog tetap akurat.</p>
                    </div>
                </div>
                ...
                <div class="tab-content" id="tab-lokasi">
                    <div class="info-grid">
                        <div class="info-grid-row">
                            ...
                            <span class="grid-value">{{ $kodeRak }}</span>
                        </div>
                        ...
                        <div class="info-grid-row">
                            ...
                            <span class="grid-value">{{ $statusTampilan }}</span>
                        </div>

                        <div class="info-grid-row">
                            <span class="grid-label">Lokasi</span>
                            <span class="grid-value">{{ $lokasiRak }}</span>
                        </div>
                    </div>
